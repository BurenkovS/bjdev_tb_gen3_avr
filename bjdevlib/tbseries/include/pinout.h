...
#define RELAY_1_PORT	PORTF
#define RELAY_1_PIN		PINF
#define RELAY_1_DDR		DDRF
#define RELAY_1_PNUM	1

#define RELAY_2_PORT	PORTF
#define RELAY_2_PIN		PINF
#define RELAY_2_DDR		DDRF
#define RELAY_2_PNUM	0

#define RELAY_3_PORT	PORTE
#define RELAY_3_PIN		PINE
#define RELAY_3_DDR		DDRE
#define RELAY_3_PNUM	2

#define RELAY_4_PORT	PORTE
#define RELAY_4_PIN		PINE
#define RELAY_4_DDR		DDRE
#define RELAY_4_PNUM	4
...
//TLC59731 PWM Controller
#define PWM_IC_PORT PORTF
#define PWM_IC_IN PINF
#define PWM_IC_DDR DDRF
#define PWM_IC_PIN 7
