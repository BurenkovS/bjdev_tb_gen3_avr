...
MENU_ITEM(Main_screen, NULL_MENU, NULL_MENU, NULL_MENU, Banks , Menu_MainScreenSelectCallback, NULL, Menu_MainScreenRedrawCallback, "", 0);
		...
		MENU_ITEM(System_Setup, Buttons_setup, Banks, Main_screen, MIDI_channel, Menu_SettingsSelectCallback, Menu_SystemSetupEnterCallback, NULL, "SYSTEM SETUP   ", 0);
			MENU_ITEM(MIDI_channel, Prg_ch_mode, Restore_defaults/*Screen_contrast*/, System_Setup, NULL_MENU, Menu_MIDIchannelSelectCallback, Menu_SystemSettingsEnterCallback, NULL, "MIDI CHANNEL   ", 0);
			...
			MENU_ITEM(Restore_defaults, MIDI_channel/*Screen_brightness*/, Bank_max, System_Setup, NULL_MENU, Menu_Restore_defaultsSelectCallback, Menu_Restore_defaultsEnterCallback, NULL, "RESTORE DEFAULT", 0);
